...
import org.lex.perf.jdbc.Params;
...
public class SpringDataSourceBeanPostProcessor implements BeanPostProcessor, PriorityOrdered {
    ...
    private final static Logger LOGGER = LoggerFactory.getLogger(SpringDataSourceBeanPostProcessor.class);
    ...
    public Object postProcessAfterInitialization(Object bean, String beanName) {
        if (bean instanceof DataSource) {
            ...
            if (isExcludedDataSource(beanName) || Params.isNoDatabase()) {
                return bean;
            }
